...
const urlCall = ApiCall("https://api.themoviedb.org/3/configuration?api_key=1f54bd990f1cdfb230adb312546d765d")
  .then(function (result) {
    ...
    return ApiCall("https://api.themoviedb.org/3/genre/movie/list?api_key=1f54bd990f1cdfb230adb312546d765d&language=en-US");
  })
  .then(function (result) {
    genres = result.genres;
    return ApiCall("https://api.themoviedb.org/3/discover/movie?api_key=1f54bd990f1cdfb230adb312546d765d&language=en-US&sort_by=primary_release_date.asc&include_adult=false&include_video=false&page=1&primary_release_date.gte=" + today);
  ...
  .then(function (result) {
    ...
    result.results.forEach(element => {
      ...
      if (movGenres.length == 0) {
        movGenres = "<b>GENRE UNAVAILABLE";
      }
